...
public class DobbeltLenketListe<T> implements Liste<T> {
    ...
    public T oppdater(int indeks, T nyverdi) {
        ...
        } else if(indeks < antall && indeks>0){
            Node gammelNode = finnNode(indeks);
            gammelVerdi = (T) gammelNode.verdi;
    ...
    private void fjernMetode(Node<T> p) {
        ...
        } else if (p == hode.neste) {
            Node temp = hode.neste.neste;
            hode.forrige = null;
            hode.neste = temp;
            temp.forrige = null;

        } else if (p == hale.forrige) {
            Node temp2 = hale.forrige.forrige;
            hale.neste = null;
            hale.forrige = temp2;
            temp2.neste = null;
        } else {
